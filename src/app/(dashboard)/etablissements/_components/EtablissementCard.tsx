...
import { EtablissementType } from './EtablissementPageSampleData';

// import { EtablissementType } from './GroupePageSampleData';

const EtablissementCard = ({ group, view }: { group: EtablissementType; view: 'grid' | 'list' }) => {
  return (
    <div
        ...
        <div>
          <Popover>
            ...
            <PopoverContent>
              <Card>
                <CardContent>
                  <Link href={`/etablissements/${group.id}`}>
                    <p>View More</p>
                  </Link>
                </CardContent>
              </Card>
...
// const EtablissementCard = ({ group }: { group: EtablissementType }) => {
//     return (
