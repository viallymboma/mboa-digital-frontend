...
const BulkContactSelectionModal: React.FC<BulkContactSelectionModalProps> = ({ isOpen, onClose }) => {
    ...
    const isContactSelected = (contact: EnterpriseContactResponseType) => 
        selectedContactsData.some(selected => selected.id === contact.id);
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-2xl h-[80vh] flex flex-col">
                ...
                {/* <div className="flex justify-end items-center mt-4 pt-4 border-t space-x-2">
                    ...
                    <Button 
                        onClick={onClose}
                        className="bg-primaryAppearance hover:bg-primaryAppearance/90"
                    >
                        Done ({selectedContactsData.length})
                    </Button>
                </div> */}
                {/* Action Buttons */}
...
//     const { contacts, addSelectedContact, toggleMultipleContacts, selectedContactsData } = useContactStore();
...
//     const handleContactSelect = (contact: EnterpriseContactResponseType) => {
//         addSelectedContact(contact);
//     };

//     const handleSelectAll = () => {
//         toggleMultipleContacts(filteredContacts);
//     };
