  ...
  return (
    <Card className="@container/card">
      <CardHeader className="relative">
        ...
        <CardDescription>
          <span className="@[540px]/card:block hidden">{t('descriptionLong')}</span>
        ...
        <div className="absolute right-4 top-4">
          ...
          <Select value={timeRange} onValueChange={setTimeRange}>
            <SelectTrigger className="@[767px]/card:hidden flex w-40" aria-label={t('selectLabel')}>
              <SelectValue placeholder={t('timeRange.90d')} />
            </SelectTrigger>
